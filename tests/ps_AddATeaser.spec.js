...
test("test", async ({ page }) => {
  ...
  const config = {
    ...
    teaserSubtext: teaserProps["Subtext for teaser"],
  };
  ...
  const newTeasers = await page
    .locator('//*[@role="link" and @title="Teaser"]')
    .all();
  ...
  await page
    .locator('//label[text()="Title"]/following-sibling::input')
    .fill("");
  await page
    .locator('//label[text()="Title"]/following-sibling::input')
    .type(config.teaserText);
  await page.getByLabel("Get description from linked page").uncheck();
  await page
    .locator(
      '//*[@data-cq-richtext-editable="true" and @data-fieldlabel="Description"]'
    )
    .fill("");
  config.teaserSubtext &&
    (await page
      .locator(
        '//*[@data-cq-richtext-editable="true" and @data-fieldlabel="Description"]'
      )
      .type(config.teaserSubtext));
